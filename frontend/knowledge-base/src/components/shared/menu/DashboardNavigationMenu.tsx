...
const DashboardNavigationMenu = ({
  ...
  return (
    <div
      ref={sidebar}
      className={`shrink-0 px-2 hidden border-r border-gray-300 dark:border-slate-600 w-fit max-w-sm md:flex bg-gray-200 flex-col z-50 left-0 top-0 sticky transform min-h-screen overflow-x-hidden overflow-y-auto no-scrollbar dark:bg-gray-950 transition-all duration-200 ease-in-out ${
