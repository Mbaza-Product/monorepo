...
from actions.api.kba import KBAbstractionLayer
from os import stat
...
class ActionDefaultAskAffirmation(Action):
    ...
    async def run(
        ...
        if (
            ...
            affirmation_buttons = [
                {"title": "Yes", "payload": f"/{intent_to_affirm}{entities}"},
        ...
        if location:
            ...
            if isPresent:
                ...
                buttons = [
                    ...
                    {"title": "No", "payload": "/lockdown_areas"},
                ]
